...
namespace Diorama
{
    void EditorDioramaUIComponent::Reflect(AZ::ReflectContext* context)
    {
        // DioramaUIConfig is reflected by the runtime component; do not reflect it
        ...
        if (auto* serializeContext = azrtti_cast<AZ::SerializeContext*>(context))
        {
            ...
            if (auto* editContext = serializeContext->GetEditContext())
            {
                editContext
                    ...
                    ->DataElement(AZ::Edit::UIHandlers::Default, &EditorDioramaUIComponent::m_config, "Config", "UI element configuration")
                    ->Attribute(AZ::Edit::Attributes::Visibility, AZ::Edit::PropertyVisibility::ShowChildrenOnly);
            }
        }
    }

    void EditorDioramaUIComponent::BuildGameEntity(AZ::Entity* gameEntity)
    {
        gameEntity->CreateComponent<DioramaUIComponent>(m_config);
    }
} // namespace Diorama
