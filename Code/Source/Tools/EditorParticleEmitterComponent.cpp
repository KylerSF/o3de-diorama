...
namespace Diorama
{
    void EditorParticleEmitterComponent::Reflect(AZ::ReflectContext* context)
    {
        // DioramaParticleConfig is reflected by the runtime component; do not reflect
    ...
    void EditorParticleEmitterComponent::GetRequiredServices(AZ::ComponentDescriptor::DependencyArrayType& required)
    {
        required.push_back(AZ_CRC_CE("TransformService"));
    }

    void EditorParticleEmitterComponent::BuildGameEntity(AZ::Entity* gameEntity)
    {
        gameEntity->CreateComponent<ParticleEmitterComponent>(m_config);
    }
} // namespace Diorama
